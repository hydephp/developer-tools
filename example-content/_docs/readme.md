# Hyde comes with a powerful documentation site builder
...
All files will automatically be added to the sidebar.
The index.md (or readme.md if there is no index.md) however will be linked through the sidebar header which is constructed using the configured site name.
